<template>
  <div class="w-full h-full relative border-2 border-gray-500 rounded-md group cursor-pointer" @click="openLightbox">
    ...
    <div class="w-full h-full flex flex-col gap-1 justify-center items-center" v-else>
      <UIcon :name="fileIcon" size="28" class="text-gray-400"></UIcon>
        ...
        <div class="lightbox-container">
          ...
          <div class="lightbox-header">
            ...
            <div class="lightbox-actions">
              <a :href="atachmentLink" target="_blank" download>
                <UButton density="compact" flat icon="i-lucide-download" class="text-gray-300 hover:text-white"></UButton>
              </a>
              <UButton density="compact" flat icon="i-lucide-x" @click="closeLightbox" class="text-gray-300 hover:text-white"></UButton>
            </div>
          </div>
          ...
          <div v-if="isImage" class="lightbox-content">
            ...
            <div class="lightbox-image-controls">
              <UButton density="compact" flat icon="i-lucide-zoom-out" @click="zoom(-0.2)" class="text-gray-300"></UButton>
              <span class="text-xs text-gray-400 font-mono w-12 text-center">{{ Math.round(scale * 100) }}%</span>
              <UButton density="compact" flat icon="i-lucide-zoom-in" @click="zoom(0.2)" class="text-gray-300"></UButton>
              <UButton density="compact" flat icon="i-lucide-refresh-ccw" @click="resetTransform" class="text-gray-300 ml-2"></UButton>
            </div>
          </div>
          ...
          <div v-else-if="is3DFile" class="lightbox-content">
            <div class="lightbox-3d-placeholder">
              <UIcon :name="fileIcon" size="64" class="text-gray-400 mb-4"></UIcon>
              ...
              <a :href="atachmentLink" target="_blank" download>
                <UButton class="text-gray-300 border-gray-600 hover:border-white">
                  <UIcon name="i-lucide-download" class="mr-2"></UIcon>
                  Download File
                </UButton>
              </a>
            </div>
          ...
          <div v-else class="lightbox-content">
            <div class="lightbox-3d-placeholder">
              <UIcon name="i-lucide-paperclip" size="64" class="text-gray-400 mb-4"></UIcon>
...
const fileExtension = computed(() => {
  ...
  const parts = `${props.atachmentLink}`.split('.') as any
